      ...
      <div className={`flex items-center gap-2 px-2 py-4 ${isCollapsed ? 'justify-center' : ''}`}>
        ...
        {!isCollapsed && (
          <>
            ...
            <div className="ml-4 flex items-center gap-2 bg-white/5 border border-white/10 px-3 py-1.5 rounded-full cursor-pointer hover:bg-white/10 transition-all" onClick={() => {
              window.location.href = "https://thoughtbook-five.vercel.app/notebooks";
            }}>
