...
return (
    <div className={`shrink-0 min-h-0 w-full bg-black/40 backdrop-blur-xl border-t border-white/10 px-2 py-2 md:py-4 z-50 shadow-[0_-4px_20px_rgba(217,70,239,0.1)]`}>
